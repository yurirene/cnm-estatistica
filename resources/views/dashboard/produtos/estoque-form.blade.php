    ...
    <div class="row mt-5">
        <div class="col-xl-12 mb-5 mb-xl-0">
            <div class="card shadow p-3">
                ...
                <div class="card-body">
                    @if (!isset($estoque))
                    {!! Form::open(['url' => route('dashboard.estoque-produtos.store'), 'method' => 'POST']) !!}
                    @else
                    {!! Form::model($estoque, ['url' => route('dashboard.estoque-produtos.update', $estoque->id), 'method' => 'PUT']) !!}
                    @endif
                    <div class="row">
                        <div class="col-md-4">
                    ...
                    <button class="btn btn-primary"><i class='fas fa-save'></i> {{(isset($estoque) ? 'Atualizar' : 'Cadastrar')}}</button>

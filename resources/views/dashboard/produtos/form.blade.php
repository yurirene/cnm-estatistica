    ...
    <div class="row mt-5">
        <div class="col-xl-12 mb-5 mb-xl-0">
            <div class="card shadow p-3">
                ...
                <div class="card-body">
                    @if (!isset($produto))
                    {!! Form::open(['url' => route('dashboard.produtos.store'), 'method' => 'POST']) !!}
                    @else
                    {!! Form::model($produto, ['url' => route('dashboard.produtos.update', $produto->id), 'method' => 'PUT']) !!}
                    @endif
                    <div class="row">
                        <div class="col-md-6">
                    ...
                    <button class="btn btn-primary"><i class='fas fa-save'></i> {{(isset($produto) ? 'Atualizar' : 'Cadastrar')}}</button>

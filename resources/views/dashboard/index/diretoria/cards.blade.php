                            ...
                            <div class="row">
                                <div class="col-6">
                                    <span class="h2 font-weight-bold mb-0">
                                        {{ $totalizador['total_sinodos'] }}
                                    </span>
                                </div>
                                <div class="col-6">
                                    <a href="{{route('dashboard.sinodais.index')}}"
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <a href="{{ route('dashboard.detalhamento.index', 'presbiterio') }}"
                                        class="btn btn-sm btn-link detalhe"
                                    >
                                        <i class="fas fa-plus"></i> Ver Mais
                                    </a>
                                </div>
                    ...
                    <div class="card card-stats mb-4 mb-xl-0 h-100">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-6">
                                    <span class="h2 font-weight-bold mb-0">
                                        {{ $totalizador['total_sinodais'] }}
                                    </span>
                                </div>

                                <div class="col-6">
                                    <a href="{{route('dashboard.sinodais.index')}}?organizadas=1"
                                        class="btn btn-sm btn-link detalhe" data-tipo="total_sinodais"
                                    >
                                        <i class="fas fa-plus"></i> Ver Mais
                                    </a>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-6">
                                    <a href="{{ route('dashboard.detalhamento.index', 'presbiterio') }}?organizadas=1"
                                        class="btn btn-sm btn-link detalhe" data-tipo="total_federacoes"
                                    >
                                        <i class="fas fa-plus"></i> Ver Mais
                                    </a>
                                </div>
                    ...
                    <div class="card card-stats mb-4 mb-xl-0 h-100">
                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                {{-- <div class="col-6">
                                    <a href="#" class="btn btn-sm btn-link detalhe" data-tipo="total_socios">
                                        <i class="fas fa-plus"></i> Ver Mais
                                    </a>
                                </div> --}}
                            </div>

<div class="row">
    <div class="col-md-3  d-flex flex-column justify-content-end">
        ...
        {!! Form::label('escolaridade[fundamental]', 'Sócios que CONCLUÍRAM UNICAMENTE o Ensino Fundamental') !!}
    ...
    <div class="col-md-3  d-flex flex-column justify-content-end">
        ...
        {!! Form::label('escolaridade[medio]', 'Sócios que CONCLUÍRAM UNICAMENTE o Ensino Médio') !!}
    ...
    <div class="col-md-3  d-flex flex-column justify-content-end">
        ...
        {!! Form::label('escolaridade[tecnico]', 'Sócios que CONCLUÍRAM UNICAMENTE o Ensino Técnico') !!}
    ...
    <div class="col-md-3  d-flex flex-column justify-content-end">
        ...
        {!! Form::label('escolaridade[superior]', 'Sócios que CONCLUÍRAM UNICAMENTE o Ensino Superior') !!}
...
<div class="row">
    <div class="col-md-3  d-flex flex-column justify-content-end">
        ...
        {!! Form::label('escolaridade[pos]', 'Sócios que CONCLUÍRAM a Pós-Graduação') !!}

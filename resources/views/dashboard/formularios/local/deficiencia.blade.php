<div class="row">
    <div class="col-md-6  d-flex flex-column justify-content-end form-group">
        ...
        @if (!empty($coletorDados))
            <small class="text-muted">Informação do coletor de dados: {{ $coletorDados['deficiencias']['surdos'] }}</small>
        @endif
    ...
    <div class="col-md-6  d-flex flex-column justify-content-end form-group">
        ...
        @if (!empty($coletorDados))
            <small class="text-muted">Informação do coletor de dados: {{ $coletorDados['deficiencias']['auditiva'] }}</small>
        @endif
...
<div class="row">
    <div class="col-md-6  d-flex flex-column justify-content-end form-group">
        ...
        @if (!empty($coletorDados))
            <small class="text-muted">Informação do coletor de dados: {{ $coletorDados['deficiencias']['cegos'] }}</small>
        @endif
    ...
    <div class="col-md-6  d-flex flex-column justify-content-end form-group">
        ...
        @if (!empty($coletorDados))
            <small class="text-muted">Informação do coletor de dados: {{ $coletorDados['deficiencias']['baixa_visao'] }}</small>
        @endif
...
<div class="row">
    <div class="col-md-6  d-flex flex-column justify-content-end form-group">
        ...
        @if (!empty($coletorDados))
            <small class="text-muted">Informação do coletor de dados: {{ $coletorDados['deficiencias']['fisica_inferior'] }}</small>
        @endif
    ...
    <div class="col-md-6  d-flex flex-column justify-content-end form-group">
        ...
        @if (!empty($coletorDados))
            <small class="text-muted">Informação do coletor de dados: {{ $coletorDados['deficiencias']['fisica_superior'] }}</small>
        @endif
...
<div class="row">
    <div class="col-md-6  d-flex flex-column justify-content-end form-group">
        ...
        @if (!empty($coletorDados))
            <small class="text-muted">Informação do coletor de dados: {{ $coletorDados['deficiencias']['neurologico'] }}</small>
        @endif
    ...
    <div class="col-md-6  d-flex flex-column justify-content-end form-group">
        ...
        @if (!empty($coletorDados))
            <small class="text-muted">Informação do coletor de dados: {{ $coletorDados['deficiencias']['intelectual'] }}</small>
        @endif

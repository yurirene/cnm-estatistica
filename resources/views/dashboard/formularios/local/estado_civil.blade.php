<div class="row">
    <div class="col-md-3">
        ...
        {!! Form::number('estado_civil[solteiros]', 0, ['class' => 'form-control', 'required' => 'required']) !!}
    ...
    <div class="col-md-3">
        ...
        {!! Form::number('estado_civil[casados]', 0, ['class' => 'form-control', 'required' => 'required']) !!}
    ...
    <div class="col-md-3">
        ...
        {!! Form::number('estado_civil[divorciados]', 0, ['class' => 'form-control', 'required' => 'required']) !!}
    ...
    <div class="col-md-3">
        ...
        {!! Form::number('estado_civil[viuvos]', 0, ['class' => 'form-control', 'required' => 'required']) !!}
...
<div class="row">
    <div class="col-md-3">
        ...
        {!! Form::number('estado_civil[filhos]', 0, ['class' => 'form-control', 'required' => 'required']) !!}

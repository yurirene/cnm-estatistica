<div class="row">
    <div class="col-md-6 col-sm-6 mt-3 d-flex flex-column justify-content-end ">
        <div class="form-group{{ $errors->has('aci[repasse]') ? ' has-error' : '' }}">
        {!! Form::label(
            'aci[repasse]',
            'A Federação fez o repasse da ACI para a Sinodal'
        ) !!}
        {!! Form::select(
            'aci[repasse]',
            ['N' => 'Não', 'S' => 'Sim'],
    ...
    <div class="col-md-3 col-sm-6 mt-3">
        ...
        {!! Form::text(
            'aci[valor]',
            isset($formulario)  && !empty($formulario->aci['valor']) ? null : 0,

<div class="row">
    <div class="col-md-3 d-flex flex-column justify-content-end ">
        ...
        {!! Form::number('estrutura[ump_organizada]', isset($formulario) ? null : $estrutura_federacao['quantidade_umps'], ['class' => 'form-control', 'required' => 'required', 'readonly' => true]) !!}
    ...
    <div class="col-md-3 d-flex flex-column justify-content-end ">
        ...
        {!! Form::number('estrutura[ump_nao_organizada]', isset($formulario) ? null : $estrutura_federacao['quantidade_sem_ump'], ['class' => 'form-control', 'required' => 'required']) !!}

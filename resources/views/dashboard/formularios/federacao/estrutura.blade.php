<div class="row">
    ...
    <div class="col-md-3 d-flex flex-column justify-content-end ">
        ...
        {!! Form::label(
            ...
            'Quantidade de igrejas do Presbitério sem UMPs organizadas:'
        ) !!}
        {!! Form::number(
            'estrutura[ump_nao_organizada]',
    ...
    <div class="col-md-3 d-flex flex-column justify-content-end ">
        ...
        {!! Form::label(
            ...
            'Quantidade de UMPs que fizeram o repasse da ACI para a Federação:'
        ) !!}
        {!! Form::number(
            'estrutura[nro_repasse]',
    ...
    <div class="col-md-3 d-flex flex-column justify-content-end ">
        ...
        {!! Form::label(
            ...
            'Quantidade de UMPs que NÃO fizeram o repasse da ACI para a Federação:'
        ) !!}
        {!! Form::number(
            'estrutura[nro_sem_repasse]',

<div class="row">
    <div class="col-md-3 col-sm-6 mt-3 d-flex flex-column justify-content-end form-group">
        ...
        {!! Form::label(
            ...
            'Quantidade de UMPs organizadas na Confederação Sinodal'
        ) !!}
        {!! Form::number(
            'estrutura[ump_organizada]',
            isset($formulario) && !empty($formulario->estrutura)
                ? null
                : $estrutura_sinodal['quantidade_ump'],
            [
                'readonly' => true,
                'id' => 'estrutura[ump_organizada]',
                'class' => 'form-control',
                'required' => 'required'
            ]
        ) !!}
    ...
    <div class="col-md-3 col-sm-6 mt-3 d-flex flex-column justify-content-end form-group">
        ...
        {!! Form::number(
            ...
            isset($formulario) && !empty($formulario->estrutura)
                ? null
                : $estrutura_sinodal['quantidade_sem_ump'],
    ...
    <div class="col-md-3 col-sm-6 mt-3 d-flex flex-column justify-content-end form-group">
        ...
        {!! Form::label(
            'estrutura[federacao_organizada]',
            'Quantidade de Federações organizadas na Confederação Sinodal'
        ) !!}
        {!! Form::number(
            'estrutura[federacao_organizada]',
            isset($formulario) && !empty($formulario->estrutura)
                ? null
                : $estrutura_sinodal['quantidade_federacoes'],
            [
                'readonly' => true,
                'id' => 'estrutura[federacao_organizada]',
                'class' => 'form-control',
                'required' => 'required'
            ]
        ) !!}
    ...
    <div class="col-md-3 col-sm-6 mt-3 d-flex flex-column justify-content-end form-group">
        ...
        {!! Form::label(
            'estrutura[federacao_nao_organizada]',
            'Quantidade de Presbitérios sem Federações organizadas'
        ) !!}
        {!! Form::number(
            'estrutura[federacao_nao_organizada]',
            isset($formulario) && !empty($formulario->estrutura)
                ? null
                : $estrutura_sinodal['quantidade_sem_federacao'],

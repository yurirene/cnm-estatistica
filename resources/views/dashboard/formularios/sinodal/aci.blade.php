<div class="row">
    <div class="col-md-3 col-sm-6 mt-3">
        ...
        {!! Form::text('aci[ump_repassaram]', 0, ['id' => 'aci[ump_repassaram]', 'class' => 'form-control', 'required' => 'required']) !!}
    ...
    <div class="col-md-3 col-sm-6 mt-3">
        ...
        {!! Form::text('aci[ump_nao_repassaram]', 0, ['class' => 'form-control', 'required' => 'required']) !!}
    ...
    <div class="col-md-3 col-sm-6 mt-3">
        ...
        {!! Form::text('aci[federacao_repassaram]', 0, ['id' => 'aci[federacao_repassaram]', 'class' => 'form-control', 'required' => 'required']) !!}
    ...
    <div class="col-md-3 col-sm-6 mt-3">
        ...
        {!! Form::text('aci[federacao_nao_repassaram]', 0, ['class' => 'form-control', 'required' => 'required']) !!}
...
<div class="row">
    <div class="col-md-3 col-sm-6 mt-3">
        <div class="form-group{{ $errors->has('aci[repasse_sinodal]') ? ' has-error' : '' }}">
            ...
            {!! Form::select('aci[repasse]',['S' => 'Sim', 'N' => 'Não'], 0, ['id' => 'aci[repasse]', 'class' => 'form-control', 'required' => 'required']) !!}

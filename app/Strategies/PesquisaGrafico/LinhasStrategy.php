...
class LinhasStrategy extends AbstractGrafico implements PesquisaGraficoStrategy
{
    ...
    public static function formatarDados(array $dados, string $tipo_dado) : array
    {
        ...
        try {
            ...
            $retorno['datasets'][] = [
                ...
                "label" => $dados['campo'],
                "data" => $quantidades,
                "borderColor" => self::getPaleta($dados),
            ];
            return $retorno;
        } catch (\Throwable $th) {
            Log::error([
    ...
    {
        return view('dashboard.pesquisas.graficos.linhas.js', [
            'dados' => $dados
        ])->render();
    }
    ...
    {
        return view('dashboard.pesquisas.graficos.linhas.html', [
            'dados' => $dados
        ])->render();
    }

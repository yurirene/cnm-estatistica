...
class SemSociedadesDatatable extends DataTable
{

    public string $titulo = 'Igrejas sem UMPs';
    public string $subtitulo = 'Lista de Igrejas que não utilizam o sistema de Sociedades Internas';
